...
if (isset($submit)) {
    ...
    if (isset($id2) && !empty($id2)) {
        ...
        $subject = Subject::find_by_id($id2);
        $subject->name = $name;
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav" style="font-size:13px; font-weight: bold; ">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link active text-light" href="subject.php"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <div style="position:relative; margin-top:0px; height: fit-content;" class="bg-light card">
        <div class="card-header">
            <div class="card-title">
                <h5 class="card-title">Subject Page</h5>
            </div>
            ...
            <div class="row">
                    ...
                    <table id="myTable" class="table" style="font-size: 13px;">
                        ...
                        <tbody>
                            ...
                            <tr class="table-primary">
                                ...
                                <!-- <td> <?php echo Classes::find_by_id($subject->class_id)->name ?? "<i>Null</i>" ?></td> -->
                                <td><a href="?id=<?php echo $subject->id ?>" class="mybtn-success"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                                            <path
                                                d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z" />
                                        </svg></a> &nbsp; <a
                                        href="actions/delete_subject.php?id=<?php echo $subject->id ?>"
                ...
                <div class="col-3">
                    <div class="row">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-subtitle mb-2 text-muted">Add Subject</h6>
                            </div>
                            <form method="POST">
                                <label for="inputPassword" class="col-form-label text-muted">Subject Name</label>
                                ...
                                <label for="inputPassword" class="col-form-label text-muted">Subject Class</label>
                                <!-- <select class="form-control form-control-sm mb-2" required type="text" name="class_id">
                                    <option value="">..Subject's Class</option>
                                ...
                                <?php echo isset($id2) ? '<a class="btn btn-sm btn-warning mb-2" href="subject.php">Cancel</a>' : "" ?>
                            </form>
                        </div>
