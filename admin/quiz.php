...
if (isset($submit)) {
    ...
    if (isset($id2) && !empty($id2)) {
        ...
        if ($quiz->save()) {
            ...
            <strong> Quiz Successfuly Updated..</strong>
        ...
        if ($quiz->save()) {
            $report = new Report;
            $report->positions = json_encode(new stdClass);
            $report->quiz_id = $quiz->id;
            $report->save();
            $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong> Quiz Successfuly Added..</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>';
        }
    }
    ...
    <div style="position:relative; margin-top:0px; height: fit-content;" class="bg-light card">
        <div class="card-header">
            <div class="card-title">
                <h5 class="card-title">Quiz Page</h5>
            </div>
            ...
            <div class="row">
                    ...
                    <table id="myTable" class="table" style="font-size: 13px;">
                        ...
                        <tbody>
                            ...
                            <tr class="table-primary">
                                ...
                                <td><a href="?id=<?php echo $quiz->id ?>" class="mybtn-success"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                                            <path
                                                d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z" />
                                        </svg></a> &nbsp; <a href="actions/delete_quiz.php?id=<?php echo $quiz->id ?>"
                ...
                <div class="col-4">
                    <div class="row">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-subtitle mb-2 text-muted">Add Quiz</h6>
                            </div>
                            <form method="POST">
                                <label for="inputPassword" class="col-form-label text-muted">Quiz Name</label>
                                ...
                                <label for="inputPassword" class="col-form-label text-muted">Class</label>
                                ...
                                <label for="inputPassword" class="col-form-label text-muted">Subject</label>
                                <select class="form-control form-control-sm mb-2" required type="text"
                                    name="subject_id">
                                    <option value="">..Subject</option>
                                    <?php $subjects = Subject::find_all();
                                    foreach ($subjects as $subject) : ?>
                                    <option
                                        <?php echo isset($subject_id2) && $subject_id2 == $subject->id ? "selected" : "" ?>
                                        value="<?php echo $subject->id ?>"><?php echo $subject->name ?></option>
                                    <?php endforeach ?>
                                </select>

                                <label for="inputPassword" class="col-form-label text-muted">Quiz Date</label>
                                <input required type="date" name="date"
                                    value="<?php echo isset($date2) ? $date2 : '' ?>" placeholder=""
                                    class="form-control form-control-sm mb-2" id="inputPassword">
                                ...
                                <?php echo isset($id2) ? '<a class="btn btn-sm btn-warning mb-2" href="quiz.php">Cancel</a>' : "" ?>
                            </form>
                        </div>
