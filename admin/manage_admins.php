...
if (isset($submit)) {
    ...
    if (isset($id2) && !empty($id2)) {
        ...
        if (isset($_FILES['picture'])) {
            ...
            $ext = $maga[0];
            if (move_uploaded_file($_FILES['picture']['tmp_name'], "./profile_img/admin_" . $username . "." . $ext)) {
                // print_r($ext);

                $admin->picture = "profile_img/admin_" . $username . "." . $ext;
            };
...
if (isset($_GET['id'])) {
    ...
    if ($admin) {
        $id2 = $admin->id;
        $name2 = $admin->name;
        $username2 = $admin->username;
        $password2 = $admin->password;
        $picture2 = $admin->picture;
    }
}
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav" style="font-size:13px; font-weight: bold; ">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link active text-light" href="manage_admins.php"><svg
    ...
    <div style="position:relative; margin-top:0px; height: fit-content;" class="bg-light card">
        <div class="card-header">
            <div class="card-title">
                <h5 class="card-title">Admins Page</h5>
            </div>
            ...
            <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr class="table-primary">
                                ...
                                <td><img class="img2 rounded-circle"
                                        src="<?php echo file_exists($admin->picture) ? $admin->picture : "profile_img/avatar.jpg"; ?>"
                                        alt="Profile Pic"></td>
                                <td> <?php echo $admin->name ?></td>
                                <td> <?php echo $admin->username ?></td>
                                <td><a href="?id=<?php echo $admin->id ?>" class="mybtn-success"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                                            <path
                                                d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z" />
                                        </svg></a> &nbsp; <a href="actions/delete_admin.php?id=<?php echo $admin->id ?>"
                ...
                <div class="col-3">
                    <div class="row">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-subtitle mb-2 text-muted">Add Admin</h6>
                            </div>
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <label for="inputPassword" class="col-form-label text-muted">Admin Name</label>
                                ...
                                <input required type="text" name="username"
                                    value="<?php echo isset($username2) ? $username2 : '' ?>" placeholder=""
                                    class="form-control form-control-sm mb-2" id="inputPassword">
                                ...
                                <?php echo isset($id2) ? '<a class="btn btn-sm btn-warning mb-2" href="manage_admin.php">Cancel</a>' : "" ?>
                            </form>
                        </div>
